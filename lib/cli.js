...
const configPath = (0, path_1.join)(process.cwd(), tsToZodConfig);
let config;
...
try {
    ...
    if (e instanceof Error) {
        (0, errors_1.error)(`"${tsToZodConfig}${configExt}" invalid:
  ${e.message}
...
See more help with --help`,
        ...
        const zodSchemasFile = getZodSchemasFile((0, getImportPath_1.getImportPath)(outputPath, inputPath) + (flags.esm ? ".js" : ""), inputPath);

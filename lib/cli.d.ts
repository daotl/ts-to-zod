...
declare class TsToZod extends Command {
    ...
    static flags: {
        ...
        esm: import("@oclif/parser/lib/flags").IBooleanFlag<boolean>;
     ...
     */
    loadFileConfig(config: TsToZodConfig | undefined, flags: OutputFlags<typeof TsToZod.flags>, ext: ConfigExt): Promise<TsToZodConfig | undefined>;
}
export = TsToZod;

 ...
 * ```
 */
function generateZodSchemaVariableStatement({ node, typeName, sourceFile, varName, zodImportValue = "z", getDependencyName = (identifierName) => (0, case_1.camel)(`${identifierName}Schema`), skipParseJSDoc = false, }) {
    let schema;
    let dependencies = [];

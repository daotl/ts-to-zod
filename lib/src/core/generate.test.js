...
describe("generate", () => {
    describe("simple case", () => {
      ...
      `;
        const { getZodSchemasFile, getIntegrationTestFile, errors } = (0, generate_1.generate)({
            sourceText,
        });
    ...
    `;
        const { getZodSchemasFile } = (0, generate_1.generate)({
            sourceText,
    ...
    describe("with non-exported types", () => {
      ...
      `;
            const { getIntegrationTestFile } = (0, generate_1.generate)({
                sourceText,
            });
